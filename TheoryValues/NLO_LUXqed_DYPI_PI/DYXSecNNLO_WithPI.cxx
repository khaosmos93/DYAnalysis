...
void DYXSecNNLO_WithPI()
{
	if( gSystem->mkdir( "./Local" ) == 0 )
	printf("Directory [Local] is created\n");

	TString AnalyzerPath = gSystem->Getenv("KP_ANALYZER_PATH");
	TString FileName_Ratio = AnalyzerPath + "/TheoryValues/NLO_LUXqed_DYPI_PI/Results/ROOTFile_DYPI_DY_FEWZ.root";
	...
	SetCanvas_Ratio(c, "Local/c_DiffXSec_DYOnly_DYPI", TopPad, BottomPad, 1, 1 );
	...
	latex.DrawLatexNDC(0.18, 0.33, "#font[42]{#scale[0.8]{PI: LUXqed, NLO}}");
	...
	TFile *f_output = TFile::Open("ROOTFile_DYXSecNNLO_WithPI.root", "RECREATE");
	f_output->cd();
