...
class GetFEWZResults:
	def __init__(self, _opts):
		...
		self.MassBinEdges = [200, 220, 243, 273, 320, 380, 440, 510, 600, 700, 830, 1000, 1200, 1500, 2000, 3000]
		self.MassBinEdges_File = [200, 220, 243, 273, 320, 380, 440, 510, 600, 700, 830, 1000, 1200, 1500, 2000, 3000]
	...
	def MakeHistogram( self ):
		...
		self.DrawHistogram(h_DiffXsec, 200, 3000)
