...
def instruction():
    ...
    print "   --isZwin isZwin                  Applying Z window or not"
...
def Add_WJetsHTBinned( _List_Samples ):
  _List_Samples.append( ["WJets_HT100to200", 1, 2] )
  _List_Samples.append( ["WJets_HT200to400", 1, 1] )
...
def Add_DYLLPtBinned( _List_Samples ):    #Min
  #_List_Samples.append( ["DYLL_Pt50to100", 1, 5] )
  _List_Samples.append( ["DYLL_Pt100to250", 1, 50] )
  _List_Samples.append( ["DYLL_Pt250to400", 1, 50] )
  #_List_Samples.append( ["DYLL_Pt400to650", 1, 1] )
  #_List_Samples.append( ["DYLL_Pt650toInf", 1, 1] )
...
try:
    MainOpts, MainArgs = getopt(sys.argv[1:], 'n', ["code=", "lumi=", "isZwin=", "queue="])
...
from Split_BatchJobs_BinDist import SplitJobs
...
for Samples in List_Samples:
  ...
  opts['--isMC'] = isMC
  opts['--isZwin'] = (int)(MainOpts['--isZwin'])
  opts['--outdir'] = OutDir
