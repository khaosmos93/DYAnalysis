...
void Calc_SumWeights()
{
	...
	vec_NtupleDir.push_back("DYntuple_v20170228_80XMoriond17_AddZprimeVar_WJets_HT70to100"); vec_Tag.push_back("WJets_HT70to100");
	vec_NtupleDir.push_back("DYntuple_v20170228_80XMoriond17_AddZprimeVar_WJets_HT100to200"); vec_Tag.push_back("WJets_HT100to200");
	vec_NtupleDir.push_back("DYntuple_v20170228_80XMoriond17_AddZprimeVar_WJets_HT200to400"); vec_Tag.push_back("WJets_HT200to400");
	vec_NtupleDir.push_back("DYntuple_v20170228_80XMoriond17_AddZprimeVar_WJets_HT400to600"); vec_Tag.push_back("WJets_HT400to600");
	vec_NtupleDir.push_back("DYntuple_v20170228_80XMoriond17_AddZprimeVar_WJets_HT600to800"); vec_Tag.push_back("WJets_HT600to800");
	vec_NtupleDir.push_back("DYntuple_v20170228_80XMoriond17_AddZprimeVar_WJets_HT800to1200"); vec_Tag.push_back("WJets_HT800to1200");
	vec_NtupleDir.push_back("DYntuple_v20170228_80XMoriond17_AddZprimeVar_WJets_HT1200to2500"); vec_Tag.push_back("WJets_HT1200to2500");
	vec_NtupleDir.push_back("DYntuple_v20170228_80XMoriond17_AddZprimeVar_WJets_HT2500toInf"); vec_Tag.push_back("WJets_HT2500toInf");
