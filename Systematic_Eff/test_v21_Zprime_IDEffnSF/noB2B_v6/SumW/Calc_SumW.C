...
void Calc_SumW()
{
	...
	TString NtuplePath = "/data5/Users/kplee/DYntuple/80X"; //gSystem->Getenv("KP_DATA_PATH");
	cout << "Current Path = "  << NtuplePath << endl;
	...
	vec_NtupleDir.push_back("DYntuple_v20170127_80XMoriond17_AddZprimeVar_DYLL_M50toInf"); vec_Tag.push_back("DYTauTau_M50toInf");
