...
public:
  ...
  void Producer()
  {
    ...
    TFile *f_output = TFile::Open("ROOTFile_Output_Systematic_Eff_"+this->Tag+"_Zwindow_v1.root", "RECREATE");
    ...
    if( nQMuons >= 2 ) // -- at least 2 muons passing ID -- //
    {
      ...
      for(Int_t i_mu=0; i_mu<nQMuons-1; i_mu++)
      {
        for(Int_t j_mu=i_mu+1; j_mu<nQMuons; j_mu++)
        {
          ...
          Bool_t Flag_Zwindow = kFALSE;
          if ( pair_temp.M > 60 &&  pair_temp.M < 120 ) Flag_Zwindow = kTRUE;
...
void ProdHist_Systematic_Eff_Zwindow_v1(Int_t _isMC, TString _FileName_ROOTFileList, Double_t _NormFactor)
{
