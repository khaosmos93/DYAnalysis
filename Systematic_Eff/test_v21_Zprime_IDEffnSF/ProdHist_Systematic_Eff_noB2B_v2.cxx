...
public:
  ...
  void Producer()
  {
    ...
    TFile *f_output = TFile::Open("ROOTFile_Output_Systematic_Eff_"+this->Tag+"_noB2B_v2.root", "RECREATE");
...
void ProdHist_Systematic_Eff_noB2B_v2(Int_t _isMC, TString _FileName_ROOTFileList, Double_t _NormFactor)
{
