		...
		for(Int_t i=0; i<nTotEvent; i++)
		{
			...
			if( GenFlag == kTRUE )
			{
				...
				if( ntuple->isTriggered( analyzer->HLT ) )
				{
					...
					Bool_t IsSelected_NUM_DENPlus5 = this->DimuonSelection_Zprime_DEN( ntuple, analyzer, QMuonCollection_NUM_DENPlus5, SelectedMuonCollection_NUM_DENPlus5 );
					...
					Bool_t IsSelected_NUM_DENPlus6 = this->DimuonSelection_Zprime_DEN( ntuple, analyzer, QMuonCollection_NUM_DENPlus6, SelectedMuonCollection_NUM_DENPlus6 );
