...
public:
	...
	void Fill( Muon mu1, Muon mu2, Double_t weight )
	{
		...
		if( mu1.Pt > mu2.Pt )
			h_RatioPt->Fill( mu1.Pt / mu2.Pt, weight );
		else
			h_RatioPt->Fill( mu2.Pt / mu1.Pt, weight );

		if( M > 400 && M < 2500 )
		{
			if( mu1.Pt > mu2.Pt )
				h_RatioPt_M400to2500->Fill( mu1.Pt / mu2.Pt, weight );
			else
				h_RatioPt_M400to2500->Fill( mu2.Pt / mu1.Pt, weight );
		}
	}
