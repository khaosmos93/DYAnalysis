...
public:
  ...
  void Producer()
  {
    ...
    TFile *f_output = TFile::Open("ROOTFile_Output_Systematic_Eff_"+this->Tag+"_PhiDip_"+theCuts_[this->theCut]+".root", "RECREATE");
...
void ProdHist_Systematic_Eff_PhiDip(Int_t _isMC, TString _FileName_ROOTFileList, Double_t _NormFactor, Int_t _theCut)
{
