...
def Add_WJetsHTBinned( _List_Samples ):
  _List_Samples.append( ["WJets_HT100to200", 1, 3] )
...
def Add_DYLLPtBinned( _List_Samples ):    #Min
  ...
  _List_Samples.append( ["DYLL_Pt250to400", 1, 1] )
...
# -- SampleName, isMC, nJobs, theCut -- #
List_Samples = []
List_Samples.append( ["Data", 0, 20, 0] )
...
List_Samples.append( ["ttbarTo2L2Nu", 1, 7] )
...
from Split_BatchJobs_PhiDip import SplitJobs

for Samples in List_Samples:
  SampleName = Samples[0]
  isMC = (int)(Samples[1])
  nJob = (int)(Samples[2])
  theCut = (int)(Samples[3])
