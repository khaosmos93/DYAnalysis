...
#include <Unfolding/src/RooUnfold.h>
...
void DrawClosureTest_FSR(TString version = "None")
{
	...
	if (version == "None" )
		FileLocation = "./";
	TFile *f_input = new TFile(FileLocation + "/ROOTFile_FSRCorrections_DressedLepton_PHOTOS.root");
...
void MakeCanvas_RespM( TH2D *h_RespM )
{
	...
	hT_RespM->GetXaxis()->SetTitle("generated mass (dressed level) [GeV]");
