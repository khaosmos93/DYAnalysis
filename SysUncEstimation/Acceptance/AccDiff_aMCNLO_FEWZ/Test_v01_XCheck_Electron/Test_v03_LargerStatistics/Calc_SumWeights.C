...
void Calc_SumWeights()
{
	...
	ofstream outFile("Local/log_Calc_SumWeights.txt", ios::out);
	...
	vec_NtupleDir.push_back("76X/DYntuple_v20170626_76X_MINIAODv2_DYLL_M10to50_25ns_LargeN"); vec_Tag.push_back("DYMuMu_M10to50");
	vec_NtupleDir.push_back("76X/DYntuple_v20170626_76X_MINIAODv2_DYLL_M50toInf_25ns_LargeN"); vec_Tag.push_back("DYMuMu_M50to100");

	vec_NtupleDir.push_back("76X/DYntuple_v20170626_76X_MINIAODv2_DYLL_M10to50_25ns_LargeN"); vec_Tag.push_back("DYEE_M10to50");
	vec_NtupleDir.push_back("76X/DYntuple_v20170626_76X_MINIAODv2_DYLL_M50toInf_25ns_LargeN"); vec_Tag.push_back("DYEE_M50to100");
