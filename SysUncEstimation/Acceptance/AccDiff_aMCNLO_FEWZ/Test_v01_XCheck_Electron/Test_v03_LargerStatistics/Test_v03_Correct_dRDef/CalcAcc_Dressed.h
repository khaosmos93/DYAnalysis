		...
		for(Int_t i_tup = 0; i_tup<Ntup; i_tup++)
		{
			...
			for(Int_t i=0; i<nTotEvent; i++)
			{
				...
				if( GenFlag == kTRUE )
				{
					...
					GenLepton genlep_dressed1 = this->LeptonDressing( ntuple, genlep_postFSR1, dRCut );
					...
					GenLepton genlep_dressed2 = this->LeptonDressing( ntuple, genlep_postFSR2, dRCut );
...
protected:
	...
	GenLepton LeptonDressing(NtupleHandle *ntuple, GenLepton& genlep_postFSR, Double_t dRCut)
	{
