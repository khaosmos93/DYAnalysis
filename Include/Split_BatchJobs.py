...
""".format(_cmd_execute=cmd_execute)
	...
	def GetNormFactor( self ):
		...
		XSecSumW_DYMMaMCNLO = {}
		XSecSumW_DYMMaMCNLO["M10to50"] = [18610.0/3.0, 7512586.0]
		...
		XSecSumW_DYMMaMCNLO["M700to800"] = [0.035/3.0, 44984.0]
		XSecSumW_DYMMaMCNLO["M800to1000"] = [0.03/3.0, 43496.0]
		XSecSumW_DYMMaMCNLO["M1000to1500"] = [0.016/3.0, 40110.0]
		XSecSumW_DYMMaMCNLO["M1500to2000"] = [0.002/3.0, 37176.0]
		XSecSumW_DYMMaMCNLO["M2000to3000"] = [0.00054/3.0, 33360.0]
