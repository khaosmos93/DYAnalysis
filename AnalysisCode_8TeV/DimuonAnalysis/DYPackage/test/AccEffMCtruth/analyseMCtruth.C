...
//   DY
  ...
  gEnv->SetValue("ProofLite.Sandbox", "/home/asvyatko/DYStudy/CMSSW_5_3_3_patch2/src/DimuonAnalysis/DYPackage/test/ControlPlots/proofbox_p2/");
  ...
  p->Process("DYM1020#/recoTree/DiMuonTree","EventSelector_MCTruthEff_PerMu.C+");
  p->Process("DYM20#/recoTree/DiMuonTree","EventSelector_MCTruthEff_PerMu.C+");
  p->Process("DYM200#/recoTree/DiMuonTree","EventSelector_MCTruthEff_PerMu.C+");
  p->Process("DYM400#/recoTree/DiMuonTree","EventSelector_MCTruthEff_PerMu.C+");
  p->Process("DYM500#/recoTree/DiMuonTree","EventSelector_MCTruthEff_PerMu.C+");
  p->Process("DYM700#/recoTree/DiMuonTree","EventSelector_MCTruthEff_PerMu.C+");
  p->Process("DYM800#/recoTree/DiMuonTree","EventSelector_MCTruthEff_PerMu.C+");
  p->Process("DYM1000#/recoTree/DiMuonTree","EventSelector_MCTruthEff_PerMu.C+");
