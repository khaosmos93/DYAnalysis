...
bool ElectronEnergyScale::initializeAllConstants(int debug){
  ...
  case Date20131217_2012_j22_peak_position : nEtaBins1=12; break;
  ...
  case Date20131217_2012_j22_peak_position: {
    //
    ...
    const double corrValues[nEtaBins] = 
      {0.99865, 0.99865, 0.99865, 0.99865, 0.99865, 0.99865, 
       0.99865, 0.99865, 0.99865, 0.99865, 0.99865, 0.99865};

    const double corrErrors[nEtaBins] = 
      {0.00135, 0.00135, 0.00135, 0.00135, 0.00135, 0.00135,
       0.00135, 0.00135, 0.00135, 0.00135, 0.00135, 0.00135};
...
// 	printf("DEBUG:  initialized smearing functino grid, amp= %f   sij= %f\n", amp, sij);
      }
	break;
      case Date20130529_2012_j22_adhoc: {
	if(_mcConst1 == 0) continue;
...
//     printf("DEBUG: computed smearing result: %f\n", result);
  }else
...
ElectronEnergyScale::CalibrationSet ElectronEnergyScale::DetermineCalibrationSet(const TString &escaleTagName_orig, TString *inputFileName) {
  ...
  else if ( (pos==0) || escaleTagName.Contains("Date20131217_2012_j22_peak_position") ) {
    calibrationSet = ElectronEnergyScale::Date20131217_2012_j22_peak_position;
  }
...
TString ElectronEnergyScale::CalibrationSetName(ElectronEnergyScale::CalibrationSet escaleTag, const TString *fileName) {
  ...
  case ElectronEnergyScale::Date20131217_2012_j22_peak_position: name="Date20131217_2012_j22_peak_position"; break;
...
TString ElectronEnergyScale::CalibrationSetFunctionName(ElectronEnergyScale::CalibrationSet escaleTag) {
  ...
  case ElectronEnergyScale::Date20131217_2012_j22_peak_position: break; // Gauss
...
TString ElectronEnergyScale::calibrationSetShortName() const {
  ...
  case ElectronEnergyScale::Date20131217_2012_j22_peak_position: name="peak20130612"; break;
