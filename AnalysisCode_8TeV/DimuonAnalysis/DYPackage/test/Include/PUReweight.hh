...
class PUReweight_t {
public:
  enum TConst { maxPVs=45 };
  typedef TConst TConst_t;
  //enum { maxPVs=45 };
  enum TReweightMethod { _none, _Hildreth, _TwoHistos };
  typedef TReweightMethod TReweightMethod_t;
  //enum { _none, _Hildreth, _TwoHistos };
protected:
