...
public:
  enum TSelectionType { _selectNone, _selectDefault };
  typedef TSelectionType TSelectionType_t; 
  enum TEScaleCorrection { _escaleNone, _escaleUncorrected, _escaleData, _escaleDataRnd, _escaleMC };
  typedef TEScaleCorrection TEScaleCorrection_t; 
protected:
