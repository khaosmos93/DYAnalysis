void QCDFrac_p3(const char* ISO, const char* REGION) {
  ...
  gEnv->SetValue("ProofLite.Sandbox", "/home/asvyatko/DYStudy/CMSSW_5_3_3_patch2/src/DimuonAnalysis/DYPackage/test/ABCDmethod/proofbox_p3/");
  ...
  p->Process("WJets#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
  p->Process("WZJetsTo3LNu#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
  p->Process("WZJetsTo2L2Q#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
  p->Process("ZZJetsTo2L2Nu#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
  p->Process("ZZJetsTo4L#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
  p->Process("ZZJetsTo2L2Q#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
  p->Process("WWJetsTo2L2Nu#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
  p->Process("tW#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
  p->Process("tbarW#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
  p->Process("tt1000#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
  p->Process("tt700#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
  p->Process("ttjets#/recoTree/DiMuonTree","EventSelector_Bkg.C+");
