#ifndef EventSelector_Bkg_h
#define EventSelector_Bkg_h
...
class EventSelector_Bkg : public TSelector {
public :
   ...
   TH1D*          Nntuple;
   TH1D*          fIsoRegMass;
   TH1D*          fIsoRegMass2030;
   TH1D*          fIsoRegMass3045;
   TH1D*          fIsoRegMass4560;
   TH1D*          fIsoRegMass60120;
   TH1D*          fIsoRegMass120200;
   TH1D*          fIsoRegMass2001500;
...
*/
   ...
   EventSelector_Bkg(TTree* =  0);
   virtual ~EventSelector_Bkg();
   ...
   ClassDef(EventSelector_Bkg,0);
};

#endif

#ifdef EventSelector_Bkg_cxx
void EventSelector_Bkg::Init(TTree *tree)
{
...
Bool_t EventSelector_Bkg::Notify()
{
...
#endif // #ifdef EventSelector_Bkg_cxx
