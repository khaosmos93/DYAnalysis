void ABCD2vari_p4(const char* ISO) { //Only iso is external, all the regions go in a loop!!! to be fed in the macro at once
...
//
  ...
  */
  ...
  p->Process("QCD15to20#/recoTree/DiMuonTree","EventSelector_Bkg2.C+");
  p->Process("QCD20to30#/recoTree/DiMuonTree","EventSelector_Bkg2.C+");
  p->Process("QCD30to50#/recoTree/DiMuonTree","EventSelector_Bkg2.C+");
  p->Process("QCD50to80#/recoTree/DiMuonTree","EventSelector_Bkg2.C+");
  p->Process("QCD80to120#/recoTree/DiMuonTree","EventSelector_Bkg2.C+");
  p->Process("QCD120to170#/recoTree/DiMuonTree","EventSelector_Bkg2.C+");
  p->Process("QCD170to300#/recoTree/DiMuonTree","EventSelector_Bkg2.C+");
