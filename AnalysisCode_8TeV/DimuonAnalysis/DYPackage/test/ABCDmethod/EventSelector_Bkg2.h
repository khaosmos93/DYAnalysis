#ifndef EventSelector_Bkg2_h
#define EventSelector_Bkg2_h
...
class EventSelector_Bkg2 : public TSelector {
public :
   ...
   TNamed *this_factorC;
   TNamed *this_factorD;
   TNamed *this_factorBerr;
   TNamed *this_factorCerr;
   TNamed *this_factorDerr;

   TNamed *this_factorB2030;
   TNamed *this_factorC2030;
   TNamed *this_factorD2030;
   TNamed *this_factorBerr2030;
   TNamed *this_factorCerr2030;
   TNamed *this_factorDerr2030;

   TNamed *this_factorB3045;
   TNamed *this_factorC3045;
   TNamed *this_factorD3045;
   TNamed *this_factorBerr3045;
   TNamed *this_factorCerr3045;
   TNamed *this_factorDerr3045;

   TNamed *this_factorB4560;
   TNamed *this_factorC4560;
   TNamed *this_factorD4560;
   TNamed *this_factorBerr4560;
   TNamed *this_factorCerr4560;
   TNamed *this_factorDerr4560;

   TNamed *this_factorB60120;
   TNamed *this_factorC60120;
   TNamed *this_factorD60120;
   TNamed *this_factorBerr60120;
   TNamed *this_factorCerr60120;
   TNamed *this_factorDerr60120;

   TNamed *this_factorB120200;
   TNamed *this_factorC120200;
   TNamed *this_factorD120200;
   TNamed *this_factorBerr120200;
   TNamed *this_factorCerr120200;
   TNamed *this_factorDerr120200;

   TNamed *this_factorB2001500;
   TNamed *this_factorC2001500;
   TNamed *this_factorD2001500;
   TNamed *this_factorBerr2001500;
   TNamed *this_factorCerr2001500;
   TNamed *this_factorDerr2001500;
   ...
   double factor_C2030;
   double factor_D2030;
   double factor_Berr2030;
   double factor_Cerr2030;
   double factor_Derr2030;

   double factor_B3045;
   double factor_C3045;
   double factor_D3045;
   double factor_Berr3045;
   double factor_Cerr3045;
   double factor_Derr3045;

   double factor_B4560;
   double factor_C4560;
   double factor_D4560;
   double factor_Berr4560;
   double factor_Cerr4560;
   double factor_Derr4560;

   double factor_B60120;
   double factor_C60120;
   double factor_D60120;
   double factor_Berr60120;
   double factor_Cerr60120;
   double factor_Derr60120;

   double factor_B120200;
   double factor_C120200;
   double factor_D120200;
   double factor_Berr120200;
   double factor_Cerr120200;
   double factor_Derr120200;

   double factor_B2001500;
   double factor_C2001500;
   double factor_D2001500;
   double factor_Berr2001500;
   double factor_Cerr2001500;
   double factor_Derr2001500;
   ...
   string sfactor_B2030;
   string sfactor_C2030;
   string sfactor_D2030;
   string sfactor_Berr2030;
   string sfactor_Cerr2030;
   string sfactor_Derr2030;

   string sfactor_B3045;
   string sfactor_C3045;
   string sfactor_D3045;
   string sfactor_Berr3045;
   string sfactor_Cerr3045;
   string sfactor_Derr3045;

   string sfactor_B4560;
   string sfactor_C4560;
   string sfactor_D4560;
   string sfactor_Berr4560;
   string sfactor_Cerr4560;
   string sfactor_Derr4560;

   string sfactor_B60120;
   string sfactor_C601200;
   string sfactor_D60120;
   string sfactor_Berr60120;
   string sfactor_Cerr60120;
   string sfactor_Derr60120;

   string sfactor_B120200;
   string sfactor_C120200;
   string sfactor_D120200;
   string sfactor_Berr120200;
   string sfactor_Cerr120200;
   string sfactor_Derr120200;

   string sfactor_B2001500;
   string sfactor_C20015000;
   string sfactor_D2001500;
   string sfactor_Berr2001500;
   string sfactor_Cerr2001500;
   string sfactor_Derr2001500;
...
*/
   ...
   Double_t        HLT_Mu13_Mu8;
   Double_t        HLT_DoubleMu6;
   Int_t           hlt_ntrig;
...
*/
   ...
   Double_t        Rapidity[1000000];   //[nPair]
...
*/
   ...
   EventSelector_Bkg2(TTree* =  0);
   virtual ~EventSelector_Bkg2();
   ...
   ClassDef(EventSelector_Bkg2,0);
};

#endif

#ifdef EventSelector_Bkg2_cxx
void EventSelector_Bkg2::Init(TTree *tree)
{
...
*/
   ...
   fChain->AddBranchToCache("Rapidity");
   fChain->AddBranchToCache("GEN*");

}

Bool_t EventSelector_Bkg2::Notify()
{
...
#endif // #ifdef EventSelector_Bkg2_cxx
