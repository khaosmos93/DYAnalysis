void analyseYield_p2(const char* WHICHHIST, const char* NTUPLEWEIGHT, const char* MOMCORRTYPE) {
...
//DYtau
  ...
  p->Process("DYM200#/recoTree/DiMuonTree","EventSelector_CP.C+");
  p->Process("DYM400#/recoTree/DiMuonTree","EventSelector_CP.C+");
  p->Process("DYM500#/recoTree/DiMuonTree","EventSelector_CP.C+");
  p->Process("DYM700#/recoTree/DiMuonTree","EventSelector_CP.C+");
  p->Process("DYM800#/recoTree/DiMuonTree","EventSelector_CP.C+");
  p->Process("DYM1000#/recoTree/DiMuonTree","EventSelector_CP.C+");
  p->Process("DYtautau1020#/recoTree/DiMuonTree","EventSelector_CP.C+");
  p->Process("DYtautau20#/recoTree/DiMuonTree","EventSelector_CP.C+");
