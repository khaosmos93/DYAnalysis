...
//   DY
  ...
  TProof* p = TProof::Open("workers=25"); // set number of works to 2:  TProof::Open("//lite:///?workers=2");
  ...
  TObjString* scenario = new TObjString(SCENARIO);
  p->AddInput(new TNamed("scenario",SCENARIO));
  ...
  p->Process("DYM1020#/recoTree/DiMuonTree","EventSelector_EffMass.C+");
  p->Process("DYM20#/recoTree/DiMuonTree","EventSelector_EffMass.C+");
  p->Process("DYM200#/recoTree/DiMuonTree","EventSelector_EffMass.C+");
  p->Process("DYM400#/recoTree/DiMuonTree","EventSelector_EffMass.C+");
  p->Process("DYM500#/recoTree/DiMuonTree","EventSelector_EffMass.C+");
  p->Process("DYM700#/recoTree/DiMuonTree","EventSelector_EffMass.C+");
  p->Process("DYM800#/recoTree/DiMuonTree","EventSelector_EffMass.C+");
  p->Process("DYM1000#/recoTree/DiMuonTree","EventSelector_EffMass.C+");
