#ifndef EventSelector_CorrMass_h
#define EventSelector_CorrMass_h
...
class EventSelector_CorrMass : public TSelector {
public :
...
*/
   ...
   Double_t        Rapidity[500000];   //[nPair]
...
*/
   ...
   Int_t           Muon1_nTrackerLayers[500000];
...
*/
   ...
   Int_t           Muon2_nTrackerLayers[500000];
...
*/
   ...
   Double_t        GENRapidity[500000];   //[GENnPair]
...
*/
   ...
   TBranch       *b_GENRapidity;   //[GENnPair]
/*
   TBranch        *b_GENAngle;   //!
...
*/
   ...
   EventSelector_CorrMass(TTree* =  0);
   virtual ~EventSelector_CorrMass();
   ...
   ClassDef(EventSelector_CorrMass,0);
};

#endif

#ifdef EventSelector_CorrMass_cxx
void EventSelector_CorrMass::Init(TTree *tree)
{
...
Bool_t EventSelector_CorrMass::Notify()
{
...
#endif // #ifdef EventSelector_CorrMass_cxx
