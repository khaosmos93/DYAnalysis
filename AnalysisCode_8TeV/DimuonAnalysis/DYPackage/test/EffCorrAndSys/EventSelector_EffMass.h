#ifndef EventSelector_EffMass_h
#define EventSelector_EffMass_h
...
class EventSelector_EffMass : public TSelector {
public :
   ...
   TH1D*          fAbsRap3045Err;
   TH1D*          fAbsRap4560Err;
   TH1D*          fAbsRap60120Err;
   TH1D*          fAbsRap120200Err;
   TH1D*          fAbsRap200Err; 
...
*/
   ...
   EventSelector_EffMass(TTree* =  0);
   virtual ~EventSelector_EffMass();
   ...
   ClassDef(EventSelector_EffMass,0);
};

#endif

#ifdef EventSelector_EffMass_cxx
void EventSelector_EffMass::Init(TTree *tree)
{
...
Bool_t EventSelector_EffMass::Notify()
{
...
#endif // #ifdef EventSelector_EffMass_cxx
