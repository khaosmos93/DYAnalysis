void mapParser(TString INPUTDIR_PREFIX, TString SCENARIO, TString BINNING, TString whichRun) { 
   ...
   if (SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03" || SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03PU" || SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03PU") {
       DENOM = "_&_Glb_pass_&_Tight2012_pass";
       funHEAD = "ISO";
   } else if (SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03_DoubleMu17Mu8_Mu8leg") {
       DENOM = "_&_Glb_pass_&_IsolPFRelCombNoEGammaR03_pass_&_Tight2012_pass";
       funHEAD = "TRIG_Mu8leg";
   } else if (SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03_DoubleMu17Mu8_Mu8") {
       DENOM = "_&_Glb_pass_&_IsolPFRelCombNoEGammaR03_pass_&_Tight2012_pass";
       funHEAD = "TRIG_Mu8";
   } else if (SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03_DoubleMu17TkMu8_TkMu8") {
       DENOM = "_&_Glb_pass_&_IsolPFRelCombNoEGammaR03_pass_&_Tight2012_pass";
       funHEAD = "TRIG_TkMu8";
   } else if (SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03_DoubleMu17Mu8_Mu17leg") {
       DENOM = "_&_Glb_pass_&_IsolPFRelCombNoEGammaR03_pass_&_Tight2012_pass";
       funHEAD = "TRIG_Mu17leg";
   } else if (SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03_DoubleMu17TkMu8_TkMu8leg") {
       DENOM = "_&_Glb_pass_&_IsolPFRelCombNoEGammaR03_pass_&_Tight2012_pass";
       funHEAD = "TRIG_TkMu8leg";
   } else if (SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03_tag_DoubleMu17Mu8_Mu17") {
       DENOM = "_&_Glb_pass_&_IsolPFRelCombNoEGammaR03_pass_&_Tight2012_pass";
       funHEAD = "TRIG_tag_Mu17";
   } else if (SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03_tag_DoubleMu17Mu8_Mu17leg") {
       DENOM = "_&_Glb_pass_&_IsolPFRelCombNoEGammaR03_pass_&_Tight2012_pass";
       funHEAD = "TRIG_tag_Mu17leg";
   } else if (SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03_DoubleMu17Mu8_Mu17") {
       DENOM = "_&_Glb_pass_&_IsolPFRelCombNoEGammaR03_pass_&_Tight2012_pass";
       funHEAD = "TRIG_Mu17";
   }

 //else if (SCENARIO == "Glb_Tight2012_IsolPFRelCombNoEGammaR03_DoubleMu22TkMu8_TkMu8_DzFilter") {
     //  DENOM = "_&_Glb_pass_&_IsolPFRelCombNoEGammaR03_pass_&_Tight2012_pass";
     //  funHEAD = "TRIG_DZFilter";
     //}
...
//   TString INPUTDIR_PREFIX = ""; //outputFiles_1fb_map/" ;
//   TString SCENARIO = "Glb_Tight2012_IsolRelTk3R03_"+TRIGGER_PATH; 
   ...
   for (int iptbin = 0; iptbin < nptbins-1; iptbin++) {
       ...
       TCanvas* cmceta = (TCanvas*)gDirectory->Get(abseta+"_PLOT_pt_bin"+TString(bin)+DENOM);
   ...
   for (int iptbin = 0; iptbin < nptbins-1; iptbin++) {
       ...
       TCanvas* cdataeta = (TCanvas*)gDirectory->Get(abseta+"_PLOT_pt_bin"+TString(bin)+DENOM);
