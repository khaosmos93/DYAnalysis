void analyse_Base() {
  ...
  cout << "WARNING: DERIVE_EFFCORR is deprecated" << endl;
...
//   DY
  ...
  TProof* p = TProof::Open("workers=10"); // set number of works to 2:  TProof::Open("//lite:///?workers=2");
  ...
  p->Process("DYM1020#/recoTree/DiMuonTree","EventSelector.C+");
  p->Process("DYM20#/recoTree/DiMuonTree","EventSelector.C+");
  p->Process("DYM200#/recoTree/DiMuonTree","EventSelector.C+");
  p->Process("DYM400#/recoTree/DiMuonTree","EventSelector.C+");
  p->Process("DYM500#/recoTree/DiMuonTree","EventSelector.C+");
  p->Process("DYM700#/recoTree/DiMuonTree","EventSelector.C+");
  p->Process("DYM800#/recoTree/DiMuonTree","EventSelector.C+");
  p->Process("DYM1000#/recoTree/DiMuonTree","EventSelector.C+");
