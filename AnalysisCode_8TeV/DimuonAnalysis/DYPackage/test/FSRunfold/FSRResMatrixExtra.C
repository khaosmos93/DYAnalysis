void FSRResMatrixExtra() { 
  ...
  //c2->Add(protocol+dirname+"DYM20_PUOct_Stefano"+"/ntuple_skim_7*.root");
  ...
  p->Process(beautifulDataset("DYM1020_PUOct")+"#/recoTree/DiMuonTree","EventSelector_FSRUnfExtra.C+");
  //p->Process(beautifulDataset("DYM20_PUOct")+"#/recoTree/DiMuonTree","EventSelector_FSRUnfExtra.C+");
  //p->Process(beautifulDataset("DYM200_PUOct")+"#/recoTree/DiMuonTree","EventSelector_FSRUnfExtra.C+");
  //p->Process(beautifulDataset("DYM400_PUOct")+"#/recoTree/DiMuonTree","EventSelector_FSRUnfExtra.C+");
  //p->Process(beautifulDataset("DYM500_PUOct")+"#/recoTree/DiMuonTree","EventSelector_FSRUnfExtra.C+");
  //p->Process(beautifulDataset("DYM700_PUOct")+"#/recoTree/DiMuonTree","EventSelector_FSRUnfExtra.C+");
  //p->Process(beautifulDataset("DYM800_PUOct")+"#/recoTree/DiMuonTree","EventSelector_FSRUnfExtra.C+");
  //p->Process(beautifulDataset("DYM1000_PUOct")+"#/recoTree/DiMuonTree","EventSelector_FSRUnfExtra.C+");
  //p->Process(beautifulDataset("DYM1500_PUOct")+"#/recoTree/DiMuonTree","EventSelector_FSRUnfExtra.C+");
  //p->Process(beautifulDataset("DYM2000_PUOct")+"#/recoTree/DiMuonTree","EventSelector_FSRUnfExtra.C+");
}
