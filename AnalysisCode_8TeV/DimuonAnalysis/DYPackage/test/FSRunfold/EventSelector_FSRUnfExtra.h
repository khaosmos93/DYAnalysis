#ifndef EventSelector_FSRUnfExtra_h
#define EventSelector_FSRUnfExtra_h
...
class EventSelector_FSRUnfExtra : public TSelector {
public :
...
//   Double_t        GENAngle[1];   //[GENnPair]
   Int_t           GENisOppSign[500000];   //[GENnPair]
...
*/
   ...
   EventSelector_FSRUnfExtra(TTree* =  0);
   virtual ~EventSelector_FSRUnfExtra();
   ...
   ClassDef(EventSelector_FSRUnfExtra,0);
};

#endif

#ifdef EventSelector_FSRUnfExtra_cxx
void EventSelector_FSRUnfExtra::Init(TTree *tree)
{
...
Bool_t EventSelector_FSRUnfExtra::Notify()
{
...
#endif // #ifdef EventSelector_FSRUnfExtra_cxx
