#ifndef EventSelector_FSRUnf_h
#define EventSelector_FSRUnf_h
...
class EventSelector_FSRUnf : public TSelector {
public :
   double Sigma_DY1020;
   double Sigma_DY20 ;
   double Sigma_DY200;
...
*/
   ...
   EventSelector_FSRUnf(TTree* =  0);
   virtual ~EventSelector_FSRUnf();
   ...
   ClassDef(EventSelector_FSRUnf,0);
};

#endif

#ifdef EventSelector_FSRUnf_cxx
void EventSelector_FSRUnf::Init(TTree *tree)
{
...
Bool_t EventSelector_FSRUnf::Notify()
{
...
#endif // #ifdef EventSelector_FSRUnf_cxx
