#ifndef EventSelector_FSRUnfBBB_h
#define EventSelector_FSRUnfBBB_h
...
class EventSelector_FSRUnfBBB : public TSelector {
public :
   double Sigma_DY1020;
   double Sigma_DY20 ;
   double Sigma_DY200;
...
*/
   ...
   EventSelector_FSRUnfBBB(TTree* =  0);
   virtual ~EventSelector_FSRUnfBBB();
   ...
   ClassDef(EventSelector_FSRUnfBBB,0);
};

#endif

#ifdef EventSelector_FSRUnfBBB_cxx
void EventSelector_FSRUnfBBB::Init(TTree *tree)
{
...
Bool_t EventSelector_FSRUnfBBB::Notify()
{
...
#endif // #ifdef EventSelector_FSRUnfBBB_cxx
