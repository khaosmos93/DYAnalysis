#define EleEventSelector_FSRUnfBBB_cxx
// The class definition in EleEventSelector_FSRUnfBBB.h has been generated automatically
...
//
// Root > T->Process("EleEventSelector_FSRUnfBBB.C")
// Root > T->Process("EleEventSelector_FSRUnfBBB.C","some options")
// Root > T->Process("EleEventSelector_FSRUnfBBB.C+")
//

#include "EleEventSelector_FSRUnfBBB.h"
...
EleEventSelector_FSRUnfBBB::EleEventSelector_FSRUnfBBB(TTree* )
{
...
EleEventSelector_FSRUnfBBB::~EleEventSelector_FSRUnfBBB() { }


void EleEventSelector_FSRUnfBBB::Begin(TTree*)
{
...
void EleEventSelector_FSRUnfBBB::SlaveBegin(TTree*)
{
...
Bool_t EleEventSelector_FSRUnfBBB::Process(Long64_t entry)
{
   ...
   // It can be passed to either EleEventSelector_FSRUnfBBB::GetEntry() or TBranch::GetEntry()
...
void EleEventSelector_FSRUnfBBB::SlaveTerminate()
{
...
void EleEventSelector_FSRUnfBBB::Terminate()
{
...
//dynamic_cast<TPair*>(fInput->FindObject("PROOF_CurrentElement")))) {
   ...
   TFile fout(TString(dName)+"_BBB_EE.root","recreate");
   Nntuple->Write();
   hpreFSR->Write();
   hpostFSR->Write();
   hpreFSR_corr->Write();
