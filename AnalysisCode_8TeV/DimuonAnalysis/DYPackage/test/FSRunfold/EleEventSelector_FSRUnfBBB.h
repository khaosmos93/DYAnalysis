#ifndef EleEventSelector_FSRUnfBBB_h
#define EleEventSelector_FSRUnfBBB_h
...
class EleEventSelector_FSRUnfBBB : public TSelector {
public :
...
*/
   ...
   EleEventSelector_FSRUnfBBB(TTree* =  0);
   virtual ~EleEventSelector_FSRUnfBBB();
   ...
   ClassDef(EleEventSelector_FSRUnfBBB,0);
};

#endif

#ifdef EleEventSelector_FSRUnfBBB_cxx
void EleEventSelector_FSRUnfBBB::Init(TTree *tree)
{
...
Bool_t EleEventSelector_FSRUnfBBB::Notify()
{
...
#endif // #ifdef EleEventSelector_FSRUnfBBB_cxx
