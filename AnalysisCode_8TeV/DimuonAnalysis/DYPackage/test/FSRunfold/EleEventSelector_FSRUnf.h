#ifndef EleEventSelector_FSRUnf_h
#define EleEventSelector_FSRUnf_h
...
class EleEventSelector_FSRUnf : public TSelector {
public :
...
*/
   ...
   EleEventSelector_FSRUnf(TTree* =  0);
   virtual ~EleEventSelector_FSRUnf();
   ...
   ClassDef(EleEventSelector_FSRUnf,0);
};

#endif

#ifdef EleEventSelector_FSRUnf_cxx
void EleEventSelector_FSRUnf::Init(TTree *tree)
{
...
Bool_t EleEventSelector_FSRUnf::Notify()
{
...
#endif // #ifdef EleEventSelector_FSRUnf_cxx
