...
#data vector 1
name_dv1 =  'ee_results_2D_2014_abs_adhoc_PI_Bayes.dat'
#covariance matrix 1
#covariance is always for rhsape for now
name_cm1 = 'covForBlue-2D-absolute_EE_Bayes.dat'
#size
length1 = '132'
#data vector 2
name_dv2 = 'mumu_results_2D_2014_abs_PI_Bayes.dat'
#covariance matrix 2
#covariance is always for rhsape for now
name_cm2 = 'covForBlue-2D-absolute_MuMu.dat'
#length2
length2 = '132' 
