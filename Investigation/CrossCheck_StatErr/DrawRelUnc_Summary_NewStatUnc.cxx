...
protected:
	void Get_Histograms()
	{
		...
		this->Hist_RelStatUnc->Set_FileName_ObjectName( "./Local/ROOTFile_Output_StatUnc_StepByStep.root", "h_RelStatUnc_DiffXSec" );
		this->Hist_RelStatUnc->Set();
		this->Hist_RelStatUnc->h->Scale( 100 );
...
void DrawRelUnc_Summary_NewStatUnc()
{
