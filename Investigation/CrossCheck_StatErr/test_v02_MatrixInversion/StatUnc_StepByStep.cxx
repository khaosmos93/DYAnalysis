...
void StatUnc_StepByStep()
{
	...
	if( Do_Test )
	{
		...
		testTool->DrawCanvas_CV_vs_Smeared( "BkgSub", 3 );
		testTool->DrawCanvas_CV_vs_Smeared( "Unfolded", 3 );
		testTool->Print_BkgSub_Unfolded_CV_Smeared( 15, 3 );

		testTool->DrawCanvas_CV_vs_Smeared( "BkgSub", 11 );
		testTool->DrawCanvas_CV_vs_Smeared( "Unfolded", 11 );
		testTool->Print_BkgSub_Unfolded_CV_Smeared( 15, 11 );

		testTool->DrawCanvas_CV_vs_Smeared( "BkgSub", 11 );
		testTool->DrawCanvas_CV_vs_Smeared( "Unfolded", 11 );
		testTool->Print_BkgSub_Unfolded_CV_Smeared( 15, 11 );

		testTool->DrawCanvas_CV_vs_Smeared( "BkgSub", 14 );
		testTool->DrawCanvas_CV_vs_Smeared( "Unfolded", 14 );
		testTool->Print_BkgSub_Unfolded_CV_Smeared( 15, 14 );

		testTool->DrawCanvas_CV_vs_Smeared( "BkgSub", 21 );
		testTool->DrawCanvas_CV_vs_Smeared( "Unfolded", 21 );
		testTool->Print_BkgSub_Unfolded_CV_Smeared( 15, 21 );

		testTool->DrawCanvas_CV_vs_Smeared( "BkgSub", 27 );
		testTool->DrawCanvas_CV_vs_Smeared( "Unfolded", 27 );
		testTool->Print_BkgSub_Unfolded_CV_Smeared( 15, 27 );

		testTool->DrawCanvas_CV_vs_Smeared( "BkgSub", 34 );
		testTool->DrawCanvas_CV_vs_Smeared( "Unfolded", 34 );
		testTool->Print_BkgSub_Unfolded_CV_Smeared( 15, 34 );

		testTool->DrawCanvas_CV_vs_Smeared( "BkgSub", 35 );
		testTool->DrawCanvas_CV_vs_Smeared( "Unfolded", 35 );
		testTool->Print_BkgSub_Unfolded_CV_Smeared( 15, 35 );
